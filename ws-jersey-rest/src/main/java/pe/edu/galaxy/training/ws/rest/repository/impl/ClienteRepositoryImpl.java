...
public class ClienteRepositoryImpl implements ClienteRepository {
	...
	@Override
	public boolean update(Cliente prmObject) throws RepositoryException {
		// TODO Auto-generated method stub
		return false;
	}

	@Override
	public boolean delete(Cliente prmObject) throws RepositoryException {
		// TODO Auto-generated method stub
		return false;
	}
	...
	public List<Cliente> findByLikeObject(Cliente cliente)
		...
		try {
			StoredProcedureQuery spq = em.createNamedStoredProcedureQuery("cliente.findByLikeObject");
